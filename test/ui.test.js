...
function getButtons(div) {
  return Array.prototype.slice.call(div.getElementsByClassName('maplibregl-draw_ctrl-draw-btn'));
}
...
test('ui buttons with one options.controls', () => {
  ...
  assert.ok(buttons[0].classList.contains('maplibregl-draw_line'), 'has line class');
  assert.ok(buttons[0].classList.contains('maplibregl-draw_ctrl-draw-btn'), 'has control class');
...
test('ui buttons with all options.controls, no attribution control', async (t) => {
  ...
  assert.ok(buttons[0].classList.contains('maplibregl-draw_point'), 'first button has point class');
  assert.ok(buttons[0].classList.contains('maplibregl-draw_ctrl-draw-btn'), 'first button has control class');
  assert.equal(buttons[0].parentNode, controlGroup, 'first button is in controlGroup');
  assert.ok(buttons[1].classList.contains('maplibregl-draw_line'), 'second button has line class');
  assert.ok(buttons[1].classList.contains('maplibregl-draw_ctrl-draw-btn'), 'second button has control class');
  assert.equal(buttons[2].parentNode, controlGroup, 'second button is in controlGroup');
  assert.ok(buttons[2].classList.contains('maplibregl-draw_polygon'), 'third button has polygon class');
  assert.ok(buttons[2].classList.contains('maplibregl-draw_ctrl-draw-btn'), 'third button has control class');
  assert.equal(buttons[1].parentNode, controlGroup, 'third button is in controlGroup');
  assert.ok(buttons[3].classList.contains('maplibregl-draw_trash'), 'fourth button has trash class');
  assert.ok(buttons[3].classList.contains('maplibregl-draw_ctrl-draw-btn'), 'fourth button has control class');
